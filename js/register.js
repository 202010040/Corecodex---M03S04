    ...
    form.addEventListener('submit', (e) => {
      ...
      if (!form.checkValidity()) {
        ...
        if (localStorage.getItem(email)) {
          showRegisterError('Un usuario con este correo ya ha sido registrado.');
        ...
        if (!validatePasswordStrength(password)) {
          showRegisterError(
            'La contraseña debe tener como minimo 8 caracteres, una máyuscula, un dígito y un simbolo'
          );
